...
public class faq_CustomWebViewClient
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("CustomerPoint.FragmentAct.faq+CustomWebViewClient, CustomerPoint", faq_CustomWebViewClient.class, __md_methods);
	}


	public faq_CustomWebViewClient ()
	{
		super ();
		if (getClass () == faq_CustomWebViewClient.class)
			mono.android.TypeManager.Activate ("CustomerPoint.FragmentAct.faq+CustomWebViewClient, CustomerPoint", "", this, new java.lang.Object[] {  });
	}
